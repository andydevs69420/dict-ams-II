...
@section("content")
    <main id="login__main" class="d-block position-relative w-100 h-100">
        ...
        <div id="login__content-area" class="d-block d-md-flex flex-column justify-content-center align-items-center position-absolute">
